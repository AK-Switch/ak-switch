...
API Key rotation proxy for AI providers

### Options

```
  -h, --help   help for akswitch
```
...
* [akswitch status](akswitch_status.md)	 - Show runtime status
* [akswitch stop](akswitch_stop.md)	 - Stop the running akswitch server
* [akswitch version](akswitch_version.md)	 - Print version information
